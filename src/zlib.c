...
static void zlib_literal(struct LZ77Context *_ectx, unsigned char c)
{
...
static void zlib_match(struct LZ77Context *_ectx, int distance, int len)
{
...
int _gsti_compress_block(unsigned char *block, int len,
...
int _gsti_decompress_block(unsigned char *block, int len,
                           unsigned char **outblock, int *outlen)
{
